...
//        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
        ...
        name_tv_f?.setText(name)
        sur_name_tv_f?.setText(sur_name)
        marks_tv_f?.setText(marks)
        percentage_tv_f?.setText(percentage)
//        Log.d("mainA","came"+name)
    ...
    fun inUI(view: View) {
        ...
        sur_name_tv_f = view.findViewById(R.id.sur_name_et)
